...
public class Colision : MonoBehaviour
{
    ...
    {
        /*
         * La instrucción Debug.Log me permite escribir un mensaje por la consola, de forma que dentro de los paréntesis
         * y ente comillas, escribiré el texto que quiero mostrar. Además, si quiero añadir el valor de una variable a
         * dicho texto, la encadeno con el símbolo +
         *
         * Una variables es un dato que almaceno en el juego para identificar cualquier tipo de valor: una velocidad,
         * el número de vidas, el tiempo transcurrido, un objeto, su nombre, el tipo de colisión, una caja de texto, un color, etc.
         */
        ...
        Debug.Log("Me he chocado con " + other.gameObject.name); //other.gameObject.name es el nombre del objeto con el que me he chocado

        /*
        * La instrucción GetComponent me permite acceder a cualquier componente de un objeto (en este caso,
        * su SpriteRenderer) y modificar una de sus propiedades (en este caso, el color)
        */
